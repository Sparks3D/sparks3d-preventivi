  ...
  return (
    <div>
      ...
      <div className="s3d-card" style={{overflow:"hidden"}}>
        {filtered.length===0?(
          <div style={{padding:"48px 0",textAlign:"center",color:"var(--text-muted)"}}>{items.length===0?'Usa "Importa da Bambu Studio" o "Importa da Orca Slicer" per importare i profili.':"Nessun risultato."}</div>
        ):(
